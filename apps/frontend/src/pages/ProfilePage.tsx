...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen px-3 py-6 text-text-primary sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-5xl flex-col gap-5">
        <section className="relative overflow-hidden rounded-lg border border-white/10 bg-bg-surface/95 p-1 shadow-[0_20px_80px_rgba(0,0,0,0.35)]">
